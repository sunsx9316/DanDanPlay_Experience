...
#if __has_include(<DDPCategory/DDPCategories.h>)
#import <DDPCategory/NSArray+DDPAdd.h>
#import <DDPCategory/NSData+DDPAdd.h>
#import <DDPCategory/NSDictionary+DDPAdd.h>
