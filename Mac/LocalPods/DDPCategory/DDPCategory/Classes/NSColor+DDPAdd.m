...
YYSYNTH_DUMMY_CLASS(NSColor_DDPAdd)


#define CLAMP_COLOR_VALUE(v) (v) = (v) < 0 ? 0 : (v) > 1 ? 1 : (v)

void DDP_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
...
void DDP_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
...
void DDP_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
...
void DDP_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(h);
    CLAMP_COLOR_VALUE(s);
    CLAMP_COLOR_VALUE(v);
...
void DDP_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
...
void DDP_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                 CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(c);
    CLAMP_COLOR_VALUE(m);
    CLAMP_COLOR_VALUE(y);
...
void DDP_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
...
void DDP_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
...
+ (NSColor *)colorWithHue:(CGFloat)hue
               saturation:(CGFloat)saturation
                lightness:(CGFloat)lightness
                    alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    DDP_HSL2RGB(hue, saturation, lightness, &r, &g, &b);
...
+ (NSColor *)colorWithCyan:(CGFloat)cyan
                   magenta:(CGFloat)magenta
                    yellow:(CGFloat)yellow
                     ...
                     alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    DDP_CMYK2RGB(cyan, magenta, yellow, black, &r, &g, &b);
    return [NSColor colorWithRed:r green:g blue:b alpha:alpha];
}
...
- (NSColor *)colorByAddColor:(NSColor *)add blendMode:(CGBlendMode)blendMode {
    ...
    return [NSColor colorWithRed:pixel[0] / 255.0f green:pixel[1] / 255.0f blue:pixel[2] / 255.0f alpha:pixel[3] / 255.0f];
}

- (NSColor *)colorByChangeHue:(CGFloat)h saturation:(CGFloat)s brightness:(CGFloat)b alpha:(CGFloat)a {
    CGFloat hh, ss, bb, aa;
    ...
    bb = bb < 0 ? 0 : bb > 1 ? 1 : bb;
    aa = aa < 0 ? 0 : aa > 1 ? 1 : aa;
    return [NSColor colorWithHue:hh saturation:ss brightness:bb alpha:aa];
}
...
- (BOOL)getHue:(CGFloat *)hue
    ...
    DDP_RGB2HSL(r, g, b, hue, saturation, lightness);
    *alpha = a;
    return YES;
}
...
- (BOOL)getCyan:(CGFloat *)cyan
    ...
    DDP_RGB2CMYK(r, g, b, cyan, magenta, yellow, black);
    *alpha = a;
    return YES;
}
