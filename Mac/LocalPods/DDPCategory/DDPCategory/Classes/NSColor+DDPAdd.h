...
extern void DDP_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
                       CGFloat *h, CGFloat *s, CGFloat *l);

extern void DDP_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
                       CGFloat *r, CGFloat *g, CGFloat *b);

extern void DDP_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
                       CGFloat *h, CGFloat *s, CGFloat *v);

extern void DDP_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                       CGFloat *r, CGFloat *g, CGFloat *b);

extern void DDP_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
                        CGFloat *c, CGFloat *m, CGFloat *y, CGFloat *k);

extern void DDP_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                        CGFloat *r, CGFloat *g, CGFloat *b);

extern void DDP_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
                       CGFloat *hh, CGFloat *ss, CGFloat *ll);

extern void DDP_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
 ...
 */
#ifndef NSColorHex
#define NSColorHex(_hex_)   [NSColor colorWithHexString:((__bridge NSString *)CFSTR(#_hex_))]
#endif

/**
 Provide some method for `NSColor` to convert color between
 ...
 */
@interface NSColor (DDPAdd)


#pragma mark - Create a NSColor Object
///=============================================================================
/// @name Creating a NSColor Object
///=============================================================================
...
/**
 ...
 @return        An NSColor object from string, or nil if an error occurs.
 */
...
/**
 ...
 @param alphaDelta       the alpha change delta specified as a value 
                         from -1.0 to 1.0. 0 means no change.
 */
- (NSColor *)colorByChangeHue:(CGFloat)hueDelta
