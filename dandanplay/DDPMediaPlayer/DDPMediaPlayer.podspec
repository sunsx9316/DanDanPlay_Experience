#
# Be sure to run `pod lib lint DDPMediaPlayer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'DDPMediaPlayer'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DDPMediaPlayer.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/sunsx9316/DDPMediaPlayer'
  ...
  # s.resource_bundles = {
  #   'DDPMediaPlayer' => ['DDPMediaPlayer/Assets/*.png']
  # }
