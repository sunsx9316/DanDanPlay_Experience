...
class CacheManager {
    ...
    func danmakuCacheWithEpisodeId(_ episodeId: Int, parametersHash: String) -> Data? {
        let episodeFolderURL = UIApplication.shared.cachesURL.appendingPathComponent("\(episodeId)")
    ...
    func matchHashWithFile(_ file: File) -> String? {
        let episodeFolderURL = UIApplication.shared.cachesURL.appendingPathComponent("fileHash.plist")
